...
<!--
### `validatePhoneNumberLength(value: string): string?`

Checks if the phone number length is correct. If it is, nothing is returned. Otherwise, a rejection reason is returned. So this function is just a more detailed version of `isPossiblePhoneNumber()`.
...
```js
import { validatePhoneNumberLength } from 'react-phone-number-input'

validatePhoneNumberLength('+90444144') === 'TOO_SHORT'
validatePhoneNumberLength('+904441444') === undefined // Length is valid.
validatePhoneNumberLength('+9044414444') === 'INVALID_LENGTH'
validatePhoneNumberLength('+90444144444') === 'INVALID_LENGTH'
validatePhoneNumberLength('+904441444444') === undefined // Length is valid.
validatePhoneNumberLength('+9044414444444') === 'TOO_LONG'
```
-->

...
export const CreateEventModal: React.FC<CreateEventModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md overlay-animate overflow-y-auto">
      <div className="relative w-full max-w-2xl rounded-3xl bg-[#111218] border border-neutral-800 text-white shadow-2xl p-6 sm:p-8 my-8 sheet-animate">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl bg-neutral-950 border border-neutral-800 text-sm text-white focus:outline-none focus:border-amber-400"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl bg-neutral-950 border border-neutral-800 text-sm text-white focus:outline-none focus:border-amber-400"
              />
            </div>

            <div className="space-y-1.5">
              <label className="text-xs font-mono text-neutral-300 font-semibold">Event Type</label>
              <select
                value={eventType}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="space-y-1.5">
              <label className="text-xs font-mono text-neutral-300 font-semibold">Event Date</label>
              <input
                type="date"
                value={eventDate}
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-mono text-neutral-300 font-semibold">Start Time</label>
              <input
                type="time"
                value={eventTime}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-mono text-neutral-300 font-semibold">City / Region</label>
              <input
                type="text"
          ...
          <div className="space-y-2">
            <label className="text-xs font-mono text-neutral-300 font-semibold flex items-center justify-between">

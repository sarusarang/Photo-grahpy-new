...
export const CreateEventModal: React.FC<CreateEventModalProps> = ({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-2xl bg-white dark:bg-[#111218] border border-neutral-200 dark:border-neutral-800 text-neutral-900 dark:text-white shadow-2xl rounded-3xl my-auto modal-animate max-h-[min(90vh,760px)] flex flex-col overflow-hidden">
        {/* Modal Header */}

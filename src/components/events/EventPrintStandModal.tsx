...
export const EventPrintStandModal: React.FC<EventPrintStandModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md overlay-animate overflow-y-auto">
      <div className="relative w-full max-w-2xl bg-neutral-900 border border-neutral-800 rounded-3xl p-6 sm:p-8 text-white shadow-2xl my-8 sheet-animate">
        {/* Modal Controls */}
        <div className="flex items-center justify-between pb-4 border-b border-neutral-800 mb-6 print:hidden">
        ...
        {/* Printable Card Container (styled with print-friendly layout) */}
        <div
          id="printable-stand-card"
          className="bg-white text-neutral-900 rounded-2xl p-8 sm:p-10 border border-neutral-200 shadow-2xl flex flex-col items-center text-center space-y-6 relative overflow-hidden"
        >
